...
old_loadStep4 = """  else if (stepNum === 4) {
...
new_loadStep4 = """  else if (stepNum === 4) {
    document.getElementById('grid-container').style.display = 'none';
    const inp = document.getElementById('input-container');
    inp.style.display = 'block';
...
html = html.replace(old_loadStep4, new_loadStep4)

old_step6 = "  else if (stepNum === 7) {"
new_step6 = "  else if (stepNum === 8) {"
...
with open('sell.html', 'w', encoding='utf-8') as f:
    f.write(html)
print("Updated sell.html variant section splitting into steps")
