...
for f in html_files:
    ...
    # We will try to replace from <footer class="footer"> to </footer>
    # Let's use regex
    pattern = re.compile(r'<!-- FOOTER -->.*?<footer class="footer">.*?</footer>', re.DOTALL | re.IGNORECASE)
    
    # If standard pattern doesn't match, try to match without <!-- FOOTER -->
    if not pattern.search(content):
        pattern = re.compile(r'<footer class="footer">.*?</footer>', re.DOTALL | re.IGNORECASE)
